...
<button style="display:none" id='b' type="button" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#paymentModal">
...
<div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="paymentModal" aria-hidden="true">
    ...
    <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="modal-text">
                    Choose a package to start enjoying our services
                    . </p>
            </div>
            <div class="modal-footer">
               
                <a href="/packages">
                <button type="button" class="btn btn-primary">Choose Packages</button>
                </a>
            </div>
        </div>
    </div>
